  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Drumherum">
        <ul>
          <li>
            <Link href="/lektionen/hash">Hashes</Link> — die Basis. Hier
            siehst du, warum reine Hashes nicht reichen.
          </li>
          <li>
            <Link href="/lektionen/entropie">Zufall & Entropie</Link> — woher
            der Salt kommt.
          </li>
          <li>
            <Link href="/lektionen/hmac">HMAC</Link> — Pepper wird oft als
