  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Weiterführend">
        <ul>
          <li>
            <Link href="/lektionen/hash">Hashes</Link> — der Baustein für
            alles hier.
          </li>
          <li>
            <Link href="/lektionen/signaturen">Signaturen</Link> — jede
            Bitcoin-Transaktion ist eine ECDSA-Signatur auf einem Hash.
          </li>
          <li>
            <Link href="/lektionen/post-quantum">Post-Quantum</Link> —
