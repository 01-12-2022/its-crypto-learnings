  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Drumherum">
        <ul>
          <li>
            <Link href="/lektionen/aes">AES</Link> — die Blockchiffre selbst.
          </li>
          <li>
            <Link href="/lektionen/hmac">HMAC</Link> — der klassische Weg,
            Integrität nachzurüsten (wenn man kein AEAD hat).
          </li>
          <li>
            <Link href="/lektionen/entropie">Zufall</Link> — woher kommen IVs
