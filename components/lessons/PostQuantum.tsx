  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Drumherum">
        <ul>
          <li>
            <Link href="/lektionen/rsa">RSA</Link> &{" "}
            <Link href="/lektionen/ecc">ECC</Link> — was migriert werden muss.
          </li>
          <li>
            <Link href="/lektionen/merkle">Merkle-Bäume</Link> — die Idee
            hinter SPHINCS+ hash-basierten Signaturen.
          </li>
          <li>
            <Link href="/lektionen/tls">TLS</Link> — hybride PQ-Modi sind seit
