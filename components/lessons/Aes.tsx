  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Was als nächstes">
        <ul>
          <li>
            <Link href="/lektionen/modi">Betriebsmodi & Padding</Link> — wie
            man AES auf längere Nachrichten anwendet (entscheidend!).
          </li>
          <li>
            <Link href="/lektionen/xor">XOR</Link> — der innere Klebstoff aller
            Modi (CTR und GCM sind im Kern XOR).
          </li>
          <li>
            <Link href="/lektionen/symm-asymm">Symm. vs. asymm.</Link> — warum
