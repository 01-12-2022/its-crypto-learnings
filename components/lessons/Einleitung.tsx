  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Wie du am besten weitermachst">
        <ul>
          <li>
            <Link href="/lektionen/kerckhoffs">Angreifer & Kerckhoffs-Prinzip</Link>{" "}
            — die Spielregeln klären, bevor wir Verfahren bauen.
          </li>
          <li>
            <Link href="/lektionen/caesar">Caesar</Link> — das einfachste
            denkbare Verfahren, um ein Gefühl zu bekommen.
          </li>
          <li>
            <Link href="/lektionen/symm-asymm">Symmetrisch vs. asymmetrisch</Link>{" "}
