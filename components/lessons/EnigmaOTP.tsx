  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Was ist davon heute relevant?">
        <ul>
          <li>
            <Link href="/lektionen/xor">XOR</Link> — der innere Mechanismus des
            OTP, auch Basis vieler moderner Stromchiffren.
          </li>
          <li>
            <Link href="/lektionen/entropie">Zufall & Entropie</Link> — OTP
            braucht <em>echten</em> Zufall, sonst ist es nutzlos.
          </li>
          <li>
            <Link href="/lektionen/aes">AES</Link> — der moderne Nachfolger: kurzer
