  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Die Bausteine in TLS">
        <ul>
          <li>
            <Link href="/lektionen/diffie-hellman">Diffie-Hellman</Link> →
            Schlüsseltausch (heute als ECDHE).
          </li>
          <li>
            <Link href="/lektionen/signaturen">Digitale Signaturen</Link> →
            Server beweist Besitz des privaten Schlüssels.
          </li>
          <li>
            <Link href="/lektionen/aes">AES</Link> +{" "}
            <Link href="/lektionen/modi">GCM</Link> → eigentliche Datenverschlüsselung.
          </li>
          <li>
            <Link href="/lektionen/hash">Hashes</Link> →{" "}
            <Link href="/lektionen/hmac">HMAC</Link>, Zertifikat-Fingerprints,
            Transcript-Hashing.
          </li>
        </ul>
      </DepthBox>
