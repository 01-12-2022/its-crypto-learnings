    ...
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Wo ECC dir begegnet">
        <ul>
          ...
          <li>
            <Link href="/lektionen/signaturen">Signaturen</Link> → ECDSA,
            Ed25519 — was Apple, GitHub, Bitcoin & Co. nutzen.
          </li>
          <li>
            <Link href="/lektionen/rsa">RSA</Link> — der ältere Verwandte zum
            Vergleich.
          </li>
          <li>
            <Link href="/lektionen/post-quantum">Post-Quantum</Link> — auch ECC
