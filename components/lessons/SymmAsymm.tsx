  ...
  return (
    <div className="lesson-card">
      ...
      <DepthBox variant="related" title="Wie es weitergeht">
        <ul>
          <li>
            <Link href="/lektionen/aes">AES</Link> — der wichtigste symmetrische
            Algorithmus.
          </li>
          <li>
            <Link href="/lektionen/diffie-hellman">Diffie-Hellman</Link> — die
            elegante Lösung fürs Schlüsseltausch-Problem.
          </li>
          <li>
            <Link href="/lektionen/rsa">RSA</Link> & <Link href="/lektionen/ecc">ECC</Link>{" "}
            — die zwei großen asymmetrischen Familien.
          </li>
          <li>
            <Link href="/lektionen/signaturen">Digitale Signaturen</Link> — die
