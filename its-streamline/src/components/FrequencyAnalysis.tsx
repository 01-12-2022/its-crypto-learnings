...
function getFrequency(text: string): Record<string, number> {
  ...
  for (const letter of ALPHABET) {
    freq[letter] = ((counts[letter] || 0) / total) * 100;
  }
  return freq;
}
    ...
    <div className="lesson-card">
      ...
      <div className="top-letters">
        ...
        <div className="letter-badges">
          {ALPHABET.sort((a, b) => freq[b] - freq[a])
            .slice(0, 5)
            .map((l) => (
      ...
      <div className="info-box">
        ...
        füge ihn hier ein. Der häufigste Buchstabe im verschlüsselten Text
        entspricht wahrscheinlich dem E im Original!
      </div>
    </div>
  );
}
